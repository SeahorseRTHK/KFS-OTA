...
kfstoken = "RVfLyu9vCUrmT2NZ8DWxQkOYT8PpIJu8sKGKKx2ASW4" #KFS
seahorsetoken = "MPkSNSnyyyxkeUqaGrcHZxtG6LNTj5vazBJmhtYshew" #Seahorse
devtoken = "qBx4XoGPSJU9zxy3tYLBnbt31AFVVGXD35GC6nlJr28" #developer's personal
SSID="KFS"
KEY="kfs123456"
...
def callback(topic, msg):
    ...
    if msg == b'photo':
        ...
        try:
            sendLINEphoto(message, None, None, kfstoken)
        except:
            print("Error")
        ...
        try:
            sendLINEphoto(message, None, text[1], kfstoken)
        except:
            print("Error")
            message = "Error while sending image"
            try:
        ...
        while count <= 50:
            ...
            try:
                sendLINEphoto(message, None, None, seahorsetoken)
            except:
                print("Error")
                message = "Error while sending image"
                try:
...
def sendLINEmsg(msg):
    ...
    request += "Authorization: Bearer " + kfstoken + "\r\n"
...
def detectFeed():
    ...
    img = sensor.snapshot()
    try:
        sendLINEphoto("Detecting feed:", img, None, seahorsetoken)
    except:
        print("Error")
        message = "Error while sending image"
        try:
